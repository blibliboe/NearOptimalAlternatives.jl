...
- After that runs, the [stable docs](https://TulipaEnergy.github.io/NearOptimalAlternatives.jl/stable) should be updated. Check them and look for the version number.
