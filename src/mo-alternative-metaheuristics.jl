...
"""
function mo_extract_constraint(
...
# TODO change this so that it works with multi objective functions in a way
"""
...
- `index_map::Dict{Int64, Int64}`: dictionary mapping indices in the JuMP/MathOptInterface model to indices of `x`.
"""
function mo_extract_bounds(model::JuMP.Model, index_map::Dict{Int64, Int64})
